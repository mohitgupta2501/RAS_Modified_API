...
// import { AlarmService, NotifyAlarm } from '../../services/alarm.service';
...
//   notifications: NotifyAlarm[] = [];   // ← NO mock data here
//   isLoading = false;
//   errorMsg = '';
...
//   ngOnInit(): void {
//     // Load once on component init so badge count shows immediately
